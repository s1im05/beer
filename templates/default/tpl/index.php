    ...
    <div class="container b-main">
        ...
        <div class="b-section" style="background: #592c71;" id="section_quadrupel">
            <div class="row">
                ...
                <div class="b-section__bottle col-xs-5">
                    ...
                    <img class="b-bottle__label" src="<?=$path?>/img/label_11.png">
                    <img class="b-bottle__label-bg" src="<?=$path?>/img/label_bg_11.png">
                </div>
            </div>
        </div>
        <div class="b-section" style="background: #2a2927;" id="section_blackray">
            <div class="row">
                ...
                <div class="b-section__bottle col-xs-5">
                    ...
                    <img class="b-bottle__label" src="<?=$path?>/img/label_12.png">
                    <img class="b-bottle__label-bg" src="<?=$path?>/img/label_bg_12.png">
                </div>
                <div class="b-section__text col-xs-6">
        ...
        <div class="b-section" style="background: #ba5619;" id="section_sitra">
            <div class="row">
                ...
                <div class="b-section__bottle col-xs-5">
                    <div class="b-bottle b-bottle-red"></div>
                    <img class="b-bottle__label" src="<?=$path?>/img/label_9.png">
                    <img class="b-bottle__label-bg" src="<?=$path?>/img/label_bg_9.png">
                </div>
            </div>
        </div>
        <div class="b-section" style="background: #3b0300;" id="section_hopwood">
            <div class="row">
                ...
                <div class="b-section__bottle col-xs-5">
                    <div class="b-bottle"></div>
                    <img class="b-bottle__label" src="<?=$path?>/img/label_10.png">
                    <img class="b-bottle__label-bg" src="<?=$path?>/img/label_bg_10.png">
                </div>
                <div class="b-section__text col-xs-6">
        ...
        <div class="b-section" style="background: #00514c;" id="section_greenwich">
            <div class="row">
                ...
                <div class="b-section__bottle col-xs-5">
                    <div class="b-bottle b-bottle-red"></div>
                    <img class="b-bottle__label" src="<?=$path?>/img/label_1.png">
                    <img class="b-bottle__label-bg" src="<?=$path?>/img/label_bg_1.png">
                </div>
            </div>
        </div>
        <div class="b-section" style="background: #003282;" id="section_belgian">
            <div class="row">
                ...
                <div class="b-section__bottle col-xs-5">
                    <div class="b-bottle"></div>
                    <img class="b-bottle__label" src="<?=$path?>/img/label_2.png">
                    <img class="b-bottle__label-bg" src="<?=$path?>/img/label_bg_2.png">
                </div>
                <div class="b-section__text col-xs-6">
        ...
        <div class="b-section" style="background: #164c2a;" id="section_apa">
            <div class="row">
                ...
                <div class="b-section__bottle col-xs-5">
                    <div class="b-bottle"></div>
                    <img class="b-bottle__label" src="<?=$path?>/img/label_4.png">
                    <img class="b-bottle__label-bg" src="<?=$path?>/img/label_bg_4.png">
                </div>
            </div>
        </div>
        <div class="b-section" style="background: #e0d8c8;" id="section_amber">
            <div class="row">
                ...
                <div class="b-section__bottle col-xs-5">
                    <div class="b-bottle b-bottle-red"></div>
                    <img class="b-bottle__label" src="<?=$path?>/img/label_5.png">
                    <img class="b-bottle__label-bg" src="<?=$path?>/img/label_bg_5.png">
                </div>
        ...
        <div class="b-section" style="background: #0d7239;" id="section_hawaii">
            <div class="row">
                ...
                <div class="b-section__bottle col-xs-5">
                    <div class="b-bottle"></div>
                    <img class="b-bottle__label" src="<?=$path?>/img/label_6.png">
                    <img class="b-bottle__label-bg" src="<?=$path?>/img/label_bg_6.png">
                </div>
            </div>
        </div>
        <div class="b-section" style="background: #f57f24;" id="section_citrus">
            <div class="row">
                ...
                <div class="b-section__bottle col-xs-5">
                    <div class="b-bottle b-bottle-red"></div>
                    <img class="b-bottle__label" src="<?=$path?>/img/label_7.png">
                    <img class="b-bottle__label-bg" src="<?=$path?>/img/label_bg_7.png">
                </div>
                <div class="b-section__text b-section__text-black col-xs-6">
        ...
        <div class="b-section" style="background: #f2d5aa;" id="section_porter">
            <div class="row">
                ...
                <div class="b-section__bottle col-xs-5">
                    ...
                    <img class="b-bottle__label" src="<?=$path?>/img/label_8.png">
                    <img class="b-bottle__label-bg" src="<?=$path?>/img/label_bg_8.png">
                </div>
            </div>
        </div>
        */?>
